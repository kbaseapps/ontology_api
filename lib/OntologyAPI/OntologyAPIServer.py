...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'OntologyAPI'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from OntologyAPI.OntologyAPIImpl import OntologyAPI  # noqa @IgnorePep8
impl_OntologyAPI = OntologyAPI(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_OntologyAPI.get_children,
                             ...
                             types=[dict])
        self.method_authentication['OntologyAPI.get_children'] = 'optional'  # noqa
        self.rpc_service.add(impl_OntologyAPI.get_parents,
                             name='OntologyAPI.get_parents',
                             types=[dict])
        self.method_authentication['OntologyAPI.get_parents'] = 'optional'  # noqa
        self.rpc_service.add(impl_OntologyAPI.get_related,
                             name='OntologyAPI.get_related',
                             types=[dict])
        self.method_authentication['OntologyAPI.get_related'] = 'optional'  # noqa
        ...
        self.rpc_service.add(impl_OntologyAPI.get_associated_ws_features,
                             ...
                             types=[dict])
        self.method_authentication['OntologyAPI.get_associated_ws_features'] = 'optional'  # noqa
        ...
        self.rpc_service.add(impl_OntologyAPI.get_namespaces,
                             ...
                             types=[])
        self.method_authentication['OntologyAPI.get_namespaces'] = 'required'  # noqa
